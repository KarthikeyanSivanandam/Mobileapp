...
return (
    ...
    <View>
          ...
          <View style={{flex:3,fontSize:25,fontFamily:'calibri'}}><Text style={styles.dc1}>Health Savings Account</Text>
          <Text style={{paddingLeft:10, textAlign:'left'}}>Employer Name</Text>
          </View>
          <View  style={{flex: 1.5,fontSize:25,fontFamily:'calibri'}}><Text style={styles.dc2}>5000</Text></View>
...
dc1:{ paddingTop:15,textAlign:'center',color:'blue',fontSize:20,fontFamily:'calibri',borderwidth:2,borderColor:'red'},
  dc2:{ paddingTop:15,textAlign:'left',color:'blue',fontSize:20,fontFamily:'calibri',borderwidth:2,borderColor:'red'},
